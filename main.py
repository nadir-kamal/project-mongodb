...
class Face_Recognition_System:
    def __init__(self, root):
        ...
        img = Image.open("C:\\Users\\viet\\PycharmProjects\\mongodb\\images\\po\\bnbn.jpg")
        ...
        img1 = Image.open("C:\\Users\\viet\\PycharmProjects\\mongodb\\images\\po\\yara.png")
        img1 = img1.resize((220, 200),  resample=Image.LANCZOS)
        self.photoimg1 = ImageTk.PhotoImage(img1)

        b1 = Button(self.root,border=0, image=self.photoimg1)
        b1.place(x=330, y=250, width=220, height=200)
        ...
        b1_1.place(x=330, y=460, width=220, height=50)

        img3 = Image.open("C:\\Users\\viet\\PycharmProjects\\mongodb\\images\\po\\this.jpg")
        ...
        '''img6 = Image.open("C:\\Users\\viet\\PycharmProjects\\mongodb\\images\\aide.jpg")
        ...
        img2 = Image.open("C:\\Users\\viet\\PycharmProjects\\mongodb\\images\\emp.jpg")
